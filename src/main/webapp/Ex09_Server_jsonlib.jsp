...
<%
    ...
    //참고 사이트
	//response.addHeader("Access-Control-Allow-Origin", "*"); //비동기 요청에 대해서 서버가 승인 (도메인에 대해서도)
	
	response.addHeader("Access-Control-Allow-Origin", "*"); //특정 요청에 대한 승인 가능
	
	//1. 서버쪽에서 풀어준다
	//2. callback 함수를 통해서 우회(?)한다.
	//등등...
	//CORS :  서로다른 도메인에 대한 요청의 문제 처리(?)
